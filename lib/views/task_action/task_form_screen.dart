...
class _TaskFormScreen extends State<TaskFormScreen> {
  ...
  void initState() {
    super.initState();
    _titleController =
        TextEditingController(text: widget.task != null ? widget.task!.title : "");
    _descriptionController =
        TextEditingController(text: widget.task != null ? widget.task!.description : "");
    _selectedDate = widget.task != null ? widget.task!.createAt : DateTime.now();
  }
